...
// // 7) 함수 타입호환성 > 매개변수 기준 (매개변수의 계수 다른 경우!!)
...
// // Generic => Generic (*종합적인) : General Hospital : 종합병원
// // 제네릭 타입을 사용하는 이유 : 현재 시점에서는 어떤 타입의 변수 및 state가 들어올지 모르고 있는 상태에서 우선, 타입을 정의해야하는 경우!
// // 반론제기 !! => 어떤 값이 들어올지 미정, 타입 치트키 : any타입 쓰면되는거아님?
...
// const str05 = returnFirstValue([1, "hi", true]);
// //제네릭 타입응용!
